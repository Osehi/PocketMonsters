...
@HiltViewModel
class PokemonViewModel@Inject constructor (private val repository:IRepository,  private val savesStateHandle: SavedStateHandle): ViewModel(), LifecycleObserver {
    val TAG = "PokemonViewModel"
    /**
     * create viewmodel object
     */
    private var _getAllPokemonResponse = MutableLiveData<DataState<Result>>()
    val getAllPokemonResponse: LiveData<DataState<Result>>
